    ...
    public class ApplicationDbContext : IdentityDbContext<Jogador> {
        ...
        protected override void OnModelCreating(ModelBuilder builder) {
            ...
            Id = 1, Name = "+1", Custo = 10, Description = "Mais 1 click por click :)", Imagem = Path.Combine(nomeLocalizacaoImagem, "Item +1.png")
                    ...
                    Id = 5, Name = "not a button", Custo = 1001, Description = "Definitivamente não é um botão", Imagem = Path.Combine(nomeLocalizacaoImagem, "not a button.png")
                }, new {
                    Id = 6, Name = "Christmas Hat", Custo = 2512, Description = "HO HO HO", Imagem = Path.Combine(nomeLocalizacaoImagem, "christmas hat.png")
                });
        }
